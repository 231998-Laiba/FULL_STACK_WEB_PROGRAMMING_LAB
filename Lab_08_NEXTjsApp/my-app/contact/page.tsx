...
<h1 className="text-3xl font-bold text-blue-600 mb-2">Contact
Us</h1>
<p className="text-gray-500 mb-8">Fill out the form and we'll get
back to you.</p>
{submitted ? (
<div className="bg-green-50 border border-green-200
text-green-700 rounded-xl p-6 text-center">
<div className="text-3xl mb-2">✅</div>
<p className="font-semibold">Message sent successfully!</p>
<p className="text-sm mt-1">Thank you, {form.name}. We'll be
in touch.</p>
