...
<p className="actions-subtitle">Click buttons or hover over them
to see events in action!</p>
...
<li><span>onMouseOver</span> — triggers when mouse enters
button</li>
<li><span>onMouseOut</span> — triggers when mouse leaves
button</li>
</ul>
</div>
</div>
